...
class TarotMachine extends Component{
    constructor(){
        ...
        this.state = {
            card: {
            number: "Este tarot possui 22 cartas que correspondem aos Arcanos Maiores. As cartas deste baralho foram criadas pelo místico e ocultista inglês Arthur Edward Waite (02.10.1857 – 19.05.1942).",
